...
(function (factory) {
    ...
    L.Control.PolylineMeasure = L.Control.extend({
        ...
        options: {
             ...
             * @default
             */
            tooltipTextFinish: 'Klicken zum <b>Beenden der Linie</b><br>',
            tooltipTextDelete: 'SHIFT-Taste und Klick zum <b>Löschen eines Punktes</b>',
            tooltipTextMove: 'Klicken und Ziehen zum <b>Verschieben Punkt</b><br>',
            tooltipTextResume: '<br>Klick ' + (isMacOS ? '⌘' : 'CTRL-Taste') + ' und Klick zum <b>Fortsetzten der Linie</b>',
            tooltipTextAdd: 'Klick ' + (isMacOS ? '⌘' : 'CTRL-Taste') + ' und Klick zum <b>Hinzufügen einen Punktes</b>',
             ...
             * @default
             */
            measureControlTitleOn: "Einschalten",
            /**
             * Title for the control going to be switched off
             * @type {String}
             * @default
             */
            measureControlTitleOff: "Ausschalten",
            /**
